...
\-: Paul Kirth
\end{DoxyAuthor}
Comp 429 Project 2 Phase I\-I\-I 
...
\mbox{[}1\mbox{]} Destination I\-P address \mbox{[}2\mbox{]} Port Number \mbox{[}3\mbox{]} High or low entropy data 'H' or 'L' \mbox{[}4\mbox{]} Size of udp data \mbox{[}5\mbox{]} Number of packets in U\-D\-P Data Train \mbox{[}6\mbox{]} Time to Live \mbox{[}7\mbox{]} Wait time in milliseconds \mbox{[}8\mbox{]} Number of tail I\-C\-M\-P messages to send 

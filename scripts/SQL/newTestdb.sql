...
CREATE TABLE `BaseResults` (
  ...
  `base_filename` int(11) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Holds the results from an experiment';
...
INSERT INTO `BaseResults` VALUES (1,1,2,'1-10',22,9999,69,0,33,0,0,1);
...
CREATE TABLE `DiscriminationResults` (
  ...
  `disc_filename` int(11) DEFAULT NULL,
  `id_pcap_data` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_Experiments` (`id_Experiments`),
...
CREATE TABLE `Experiments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Holds Experiment metadata and experimental results';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=latin1 COMMENT='Holds pcap data for each measuement';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pcap_data` VALUES (1,1,'base'),(2,1,'discrimination'),(14,1,'poop'),(15,1,'MY poopmysql -u rootmysql -u root'),(16,1,'MY poopmysql -u rootmysql -u root');
...
-- Dump completed on 2016-03-19  2:00:57
